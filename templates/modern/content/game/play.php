...
<div id="topad" class="fn-clear">
    ...
    <div class="adbox bgs fn-right">
        <div class="adtitle">
            <img src="{{CONFIG_THEME_PATH}}/image/bg_fea.png" alt="">
        </div>
...
<div id="game-bottom" class="bgs fn-clear">
    <div class="game-dec fn-left">
        ...
        <div class="description">
            <span class="pl game-title">{{PLAY_GAME_NAME}}</span>
            <br>
            <span class="pl">Add This Game to Your Site:</span>
            <br>
            <textarea class="embedcode" name="" id="" cols="30" rows="10" onclick="this.select();">{{PLAY_GAME_EMBED}}</textarea>
            <br>
            <span class="pl">Link To The Game:</span>
            <br>
            <textarea class="embedcode" name="" id="" cols="30" rows="10" onclick="this.select();">{{PLAY_GAME_EMBED2}}</textarea>
        </div>
        <p class="d-text">
            {{PLAY_GAME_DESC}}
        </p>
